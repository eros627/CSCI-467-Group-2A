...
function database(prefix, defaults = {}) {
    return {
        ...
        port: integer(`${prefix}_PORT`, defaults.port || 3306),
...
export function loadConfig() {
    ...
    const config = {
        ...
        appDb: database('APP_DB', { database: 'auto_parts_app', connectionLimit: 10 }),
        legacyDb: database('LEGACY_DB', { database: 'csci467', connectionLimit: 5 }),
        payment: {
